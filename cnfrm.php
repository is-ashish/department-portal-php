...
echo '<script language="javascript">';
                    echo 'bootbox.alert("<div class=text-success><br>Password Updated....</div>")';
                    echo '</script>';
?>
</head>
<body>
...
<form class="form-horizontal" method="post" name="phpForm" action="adminlogin.php">
<fieldset>
<br /><br />
<div class="row">
