...
<head>
	...
	<title>Faculty_EDIT_NOTICE</title>
...
$query="select SNO,TITLE,CONTENT,STATUS,OUTPUT from noticemas where sno=$sno and createby='Faculty'";
        ...
        <div class="panel panel-primary" >
                <div class="bgcolor">
                    <div class=" panel-heading "> 
                      <a href="teachernoticedb.php"  style="margin-top: 13px;float:right;margin-right: 20px;"  type="button" class="btn btn-info myhomebtn">Notice-Board</a>
...
function validate(){
   ...
   if(title.val()==""){
    ...
    bootbox.confirm("<div class=infomessage><br />Are you sure to Update this notice ?</div>",function(res){
       if(res==true){
         $.post("t_editnotice1.php",$('#phpForm').serialize(),
            function(res){
                if(res=="OK"){
