...
<div class="form-group">
  ...
  <div class="col-md-8">
    <input type="submit" id="submit" name="Submit" onsubmit="reterive()" class="btn btn-success" value="Submit" />
...
if($i==1){
   echo '<script language="javascript">';
                            echo 'bootbox.confirm("<div class=successmessage><br>You have successfully add a student<br><br>His / Her Roll Number is : <div class=errormessage style=float:right>'.$ROLLNO.'</div><br><div class=smallinfomessage>( This will be his / her <b>USER ID</b> )<br />Do you want to add more?</div></div>",function(res){';
                                    echo 'if(res==true){';
                                    
                            echo 'window.location="adminstudentreg.php";';
                                 echo '}  ';
                                 echo 'else{';
                                    echo 'window.location="s_admin.php";';
                                 echo '} '; 
                            echo '});'; 
    echo '</script>';
 }
else if($i==2){
    $query="DELETE from studentmas WHERE sid=$SID";
