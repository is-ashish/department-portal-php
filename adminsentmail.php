...
$query="SELECT DATE,SNO,senderid,body,sbjct,sendto FROM sendmas where senderid='$_SESSION[uid]' order by date desc";
$result=mysqli_query($link,$query);
?>
<br /><br /><br /><br /><br /><br />
<form id="phpForm" name="phpForm" method="post" action="adminsentmail.php">
...
<div class="panel panel-success"> 
    ...
    <div class="panel-heading">
       <div class="row">
                    <div class="col-xs-3"><h3 >Sent Mail</h3></div><div class="col-md-5"></div>
    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            ?>
            <div class="col-md-2">
                <a href="javascript:void(0)" id="edit" onclick="forwardmail()" class="btn btn-success"><span class="glyphicon glyphicon-send"></span> &nbsp;&nbsp;Forward a Mail</a>
            </div>
            <span class="hidden-lg hidden-md"><br /></span>
            <div class="col-md-2">
                <a href="javascript:void(0)" id="delete" onclick="deletemail()" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> &nbsp;&nbsp;Delete Sent Mail</a>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        while($data=mysqli_fetch_array($result,MYSQLI_ASSOC)){
                            ...
                            echo "</td>";
                            echo "<td><span class='more'>".$data['sendto']."</span></td>";
...
function forwardmail(){
    ...
    if(count>1){
        bootbox.alert("<div class=errormessage><br />Can't Forward multiple mails at a time</div>");
        return false;
    }
    var val;
    for(var i=0;i<ch.length;i++){
    ...
    bootbox.confirm("<div class=infomessage><br />Do you want to forward the selected Mail ?</div>",function(res){
        if(res==true){
            var sno=document.getElementById('sno');
            sno.value=val;
              phpForm.action="adminnewmail.php?code=1&sno="+val;
            phpForm.submit();
        }    
    });
