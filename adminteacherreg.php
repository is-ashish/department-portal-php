...
if($_POST['Jyear']==-1){  
        $i=1;  
        $str="<div class=errormessage><br>You must have to select a joining year</div>";
}
else if($_POST['Ftype']==-1){  
        $i=1;  
        $str="<div class=errormessage><br>You must have to select a type</div>";
}
else{
    session_start();
    $_SESSION['joinyear']=$_POST['Jyear'];
    $_SESSION['ftype']=$_POST['Ftype'];
    header("location:adminteacherreg2.php");
}
}
...
<body><br />
<?php include('suc_header.php'); ?><br /><br /><br /><br /><br /><br /><br />
...
<!-- Password input-->
<div class="form-group">
<label class="col-md-4 control-label" for="ftype">Select Type<label style="color: red;" for="ftype"> * </label> :</label>
  <div class="col-md-4">
...
<div class="form-group">
  ...
  <div class="col-md-8">
    ...
    <a href="s_admin.php" type="button" id="next"  class="btn btn-primary " >Cancel</a>
  </div>
</div>
