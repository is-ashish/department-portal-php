...
<head>
	...
	<title>FACULTY_ComposeMail</title>
...
if(isset($_REQUEST['sno']) && isset($_REQUEST['code'])) {
    $sno=$_REQUEST['sno'];
    if($_REQUEST['code']==1){
        $query="SELECT body,sbjct,sendto FROM sendmas where senderid='$_SESSION[utid]' and sno='$sno' order by date desc";
    ...
    $query="SELECT body,sbjct,sendto FROM mailsavemas where id='$_SESSION[utid]' and sno='$sno' order by date desc";
    $result=mysqli_query($link,$query);
     if(mysqli_affected_rows($link)>0){
        $data=mysqli_fetch_array($result,MYSQLI_ASSOC);
        $to=$data['sendto'];
...
<form class="form-horizontal" method="post" name="phpForm" id="phpForm" action="teachernewmail1.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2"></div>
                                <div class="col-md-8">&nbsp;&nbsp;
                                    ...
                                    <a href="s_teacher.php" type="button" id="cancel"  class="btn btn-warning" ><span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Cancel</a>
...
function validateSend(){
    ...
    document.getElementById('phpForm').action="teachernewmail1.php";
...
function validateSave(){
    ...
    $.post("teachersavemail1.php",$('#phpForm').serialize(),
            function(res){
                    ...
                    {bootbox.confirm("<div class=successmessage><br />Mail saved Successfully.....<br /><div class=infomessage>Do you want to send more <strong>Mail</strong>? </div></div>",function(r){
                        if(r==true){
                            window.location="teachernewmail.php";
                         }
                         else
                         {  
