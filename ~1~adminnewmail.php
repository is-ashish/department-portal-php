...
while($data=mysqli_fetch_array($result,MYSQLI_ASSOC)){
        $str=$str."\"";
        $str=$str."$data[email]"." [ "." $data[fname] $data[lname] , ("." STUDENT"." ) ]";
        $str=$str."\"";
        $str=$str.",";
    }
...
while($data=mysqli_fetch_array($result,MYSQLI_ASSOC)){
        $str=$str."\"";
        $str=$str."$data[email]"." [ "." $data[fname] $data[lname] , ("." FACULTY"." ) ]";
        $str=$str."\"";
        $str=$str.",";
    }
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input id="to" name="To" class="form-control"   type="text" class="form-control" autocomplete="off" required=""/>
                                </div>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <textarea rows="7" cols="20" class="form-control" id="body" name="Body" required=""></textarea> </div>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                        <div class="form-group">
...
function validateSave(){
    document.getElementById('phpForm').action="adminsavemail1.php";
    document.getElementById('phpForm').submit();
...
function changetext(){  // do something…
 ...
 function deattachall(){
  ...
  if(isset($_SESSION['send']) && isset($_SESSION['value'])){
    ...
    <?php }
    else if($_SESSION['value']=="m"){
        ?><script>
            bootbox.alert("<div class=errormessage><br />Mandeep</div>");
        </script>
    <?php }
    }
