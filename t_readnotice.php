...
$query="select DATE_FORMAT(DATE,'%d-%b-%Y') DATE,SNO,TITLE,CONTENT,STATUS,OUTPUT,CREATEBY,SENDERNAME,SENDERID from noticemas where sno=$_POST[Sno] and createby='Faculty'";
...
<div class="panel panel-success"> 
    ...
    <a href="teachernoticedb.php"  style="float: right;margin-top: 12px;  margin-right: 20px;" ><input type="button" class="btn btn-info myhomebtn" value="  Notice-board  "/></a>
