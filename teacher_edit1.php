...
include('connection.php');
    ...
    $type=$_POST['Type'];
            ...
            $query="update teacherdetail set FNAME='$fname',MNAME='$mname',LNAME='$lname',MOBNO='$mob',EMAIL='$email',FATHERNAME='$fathername',DOB='$dob',GENDER='$gender',type='$type' WHERE teacherid='$_SESSION[utid]'";
            $result=mysqli_query($link,$query);
            if(mysqli_affected_rows($link)>0){
