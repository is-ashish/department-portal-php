...
$UID=$_SESSION['utid'];
unset($arr);
$query="SELECT MOBNO FROM teacherdetail WHERE teacherid='$UID'";
...
$MOB=$_POST['Mob'];
if($data['MOBNO']==$MOB){
    header("location:tcchangepass.php");
}
else{$i=1;}
}
?>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    ...
    <a href="teacherlogin.php"><input type="button"  class="btn btn-primary" value="Cancel" /></a>
  </div>
</div>
