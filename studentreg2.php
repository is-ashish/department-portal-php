...
if($i==1){
   echo '<script language="javascript">';
                            echo 'bootbox.confirm("<div class=successmessage><br>You have successfully registered<br><br>Your Roll Number is : <div class=errormessage style=float:right>'.$ROLLNO.'</div><br><div class=smallinfomessage>( This will be your <b>USER ID</b> )</div></div>",function(res){';
                                    echo 'if(res==true){';
                                    
                            echo 'window.location="studentlogin.php";';
                                 echo '}  ';
                                 echo 'else{';
                                    echo 'window.location="studentreg.php";';
                                 echo '} '; 
                            echo '});'; 
    echo '</script>';
 }
