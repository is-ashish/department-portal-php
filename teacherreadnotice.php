...
$query="select DATE_FORMAT(DATE,'%d-%b-%Y') DATE,SNO,TITLE,CONTENT,CREATEBY from noticemas where sno='$_GET[sno]' and title='$_GET[title]' and createby='Admin' and output in ('Both','Faculty') and status='1'";
...
hr{
 ...
 <body>
 <?php include('tcsuc_header.php'); ?><br /><br /><br /><br /><br />
 <div class="container">
<div class="panel panel-success"> 
    <div class="bgcolor">    
    <div class="panel-heading">
    
    <a href="teachernoticedb1.php"  style="float: right;margin-top: 12px;  margin-right: 20px;" ><input type="button" class="btn btn-info myhomebtn" value="  Notice-board  "/></a>
 ...
 if($i==1){
    ...
    bootbox.confirm("<?php echo $str;?>",function(res){
        if(res==true){
            window.location="teachernoticedb1.php";
        }
        else{
            window.location="teachernoticedb1.php";
        }
