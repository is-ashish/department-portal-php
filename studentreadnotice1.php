...
$query="select DATE_FORMAT(DATE,'%d-%b-%Y') DATE,SNO,TITLE,CONTENT,CREATEBY from noticemas where sno='$_GET[sno]' and title='$_GET[title]' and createby='Faculty' and status='1' and output in ('Both','Student')";
...
<div class="panel panel-success"> 
    ...
    <a href="studentnoticedb1.php"  style="float: right;margin-top: 12px;  margin-right: 20px;" ><input type="button" class="btn btn-info myhomebtn" value="  Notice-board  "/></a>
 ...
 if($i==1){
    ...
    bootbox.confirm("<?php echo $str;?>",function(res){
        if(res==true){
            window.location="studentnoticedb1.php";
        }
        else{
            window.location="studentnoticedb1.php";
        }
