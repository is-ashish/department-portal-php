                    ...
                    <div class="panel panel-primary" >
                        <div class="bgcolor">
                            ...
                            <input type="button" onclick="statechanged()" class="btn btn-primary myhomebtn" style="float: right; margin-right:30px;margin-top: 12px; " value="  Edit  "/>
                                <h3 ><?php echo "$_SESSION[utname]'s"; ?> Profile</h3>
                             </div>
                        </div>
...
function validate(){
  ...
  var dob=$('#dob');
   ...
   if(fname.val()==""){
    ...
    bootbox.confirm("<div class=infomessage><br />Are you sure to submit this form?</div>",function(res){
       if(res==true){
       
           $.post("tceditprofile1.php",$('#phpForm').serialize(),
            function(res){
               if(res=="OK"){
