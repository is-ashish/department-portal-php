...
$UID=$_POST['Username'];
$query="SELECT USERID FROM admin WHERE USERID='$UID'";
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <input id="username" name="Username" type="text" placeholder="Enter the Username" class="form-control input-md" required=""  />
    </div>
<div class="row"></div>
<div class="row">
